...
namespace DCodeGitForksODataWebApivNextsamples.Migrations
{
    ...
    [Migration("20160801204903_AddUserType")]
    partial class AddUserType
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ODataSample.Web.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("ODataSample.Web.Models.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ODataSample.Web.Models.ApplicationRole")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ODataSample.Web.Models.ApplicationUser", b =>
                {
                    b.HasOne("ODataSample.Web.Models.Product", "FavouriteProduct")
                        .WithMany()
                        .HasForeignKey("FavouriteProductId");

                    b.HasOne("ODataSample.Web.Models.Product", "UsedProduct")
            ...
            modelBuilder.Entity("ODataSample.Web.Models.Order", b =>
                {
                    b.HasOne("ODataSample.Web.Models.Customer", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("ODataSample.Web.Models.Product", b =>
                {
                    b.HasOne("ODataSample.Web.Models.ApplicationUser", "CreatedByUser")
                    ...
                    b.HasOne("ODataSample.Web.Models.ApplicationUser", "LastModifiedByUser")
                        .WithMany("ProductsLastModified")
